...
const renderContactFilterLabel = () => {
    ...
    const contactItems = contactsToRender.map((contact) => {
      ...
      <div class="contact-item grid grid-cols-6 p-2 hover:bg-indigo-200 rounded-md gap-5 cursor-pointer">
          ...
          <div>${contact.company} - ${contact.jobTitle}</div>
...
const deleteContact = (contactId) => {
    ...
    showToast("Success Delete Contact!")
}
...
const openDesk = (contact) => {
  ...
  <div class="p-5 w-80">
      ...
      <div class="flex items-center gap-2 mb-2">
        ...
        <div class="text-xl">${contact.phone}</div>
      </div>
      <div class="flex items-center gap-2 mb-2">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        ...
        id="logoLabel"
        >
          <path d="M24.896 9.463a.997.997 0 0 0-.707-.293l-12.957-.001a1 1 0 0 0-1 .996l-.046 13.005a.998.998 0 0 0 .293.711l16.995 16.995a.997.997 0 0 0 1.414 0l13.004-13.004a.999.999 0 0 0 0-1.414L24.896 9.463zm3.285 29.292L12.188 22.761l.041-11.592 11.547.001 15.995 15.995-11.59 11.59z"></path>
          <circle cx="20.362" cy="19.346" r="2.61"></circle>
      </svg>
      <div class="text-xl">${contactLabel}</div>
    </div>
    ...
    <div class="text-xl">${contact.company} - ${contact.jobTitle}</div>
    </div>
  </div>
`
...
const editContact = (event) => {
    ...
    saveContact(updatedContacts)
    toggleModal("formContactModal")
    showToast("Success Edit Contact!")
    closeDesk()
    return renderContactFilterLabel()
}
...
const deleteLabel = (id) => {
    ...
    renderLabels()
    renderContactFilterLabel()
    showToast("Success Delete Label!")
}
